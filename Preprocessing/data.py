...
def create_data():
    ...
    base_dir = '/home/xingyu/Desktop/zjy/Building Segmentation using U-net-master/deform'

    data_origin_dir = os.path.join(base_dir, 'train')
    ...
    np.save('../data/data_zjy_.npy', imgdata)
